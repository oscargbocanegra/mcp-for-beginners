...
server.registerResource("saludar", new ResourceTemplate("saludar://{nombre}", { list: undefined }), { title: "Saludar", description: "Saluda a una persona por su nombre" }, async (url, { nombre }) => {
